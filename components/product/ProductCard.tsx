...
export function ProductCard({ product }: ProductCardProps) {
  ...
  return (
    <Link href={`/product/${product.id}`}>
      <div className="bg-white rounded-md p-4 hover:shadow-lg transition-all duration-200 cursor-pointer relative group h-full flex flex-col">
        {/* Favorite */}
        <button
          onClick={(e) => {
            e.preventDefault();
        ...
        <div className="flex-1 flex flex-col">
          {/* Title */}
          <h3 className="text-[14px] text-[#333] line-clamp-2 mb-3 leading-[1.3]">
            {product.title}
          </h3>
          ...
          <div className="mt-auto">
            ...
            <div className="flex items-baseline gap-2 mb-2">
              <span className="text-[28px] font-light text-[#333]">
